  ...
  useEffect(() => {
    const fetchHistory = async () => {
      ...
      try {
        ...
        setTransactionInfo(transactionData.data.transactions); // Set transaction array directly
        ...
        console.log(tripData.data.trips);
        setTripInfo(tripData.data.trips); // Correctly set trip data
